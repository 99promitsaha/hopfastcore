...
export function registerResources(server) {
    // ─── hopfast://guide ───────────────────────────────────────────────────────
    server.resource('hopfast://guide', 'HopFast Agent Guide — workflows, authentication, and best practices', async () => ({
        contents: [
            {
                uri: 'hopfast://guide',
    ...
    // ─── hopfast://chains ──────────────────────────────────────────────────────
    server.resource('hopfast://chains', 'Supported blockchain networks with chain IDs, native tokens, and popular token addresses', async () => ({
        contents: [
            {
                uri: 'hopfast://chains',
